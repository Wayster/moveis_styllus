...
<script>
  ...
  <body>
      ...
      <div class="collapse navbar-collapse" id="navbar1">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="contact.php">
            ...
            Contato</a></li>
          <!-- <li class="nav-item">
            <a href="where.php" class="nav-link">
            <img src="css/img/world.png" alt="">
            Onde Encontrar
          </a>
          </li> -->
        </ul>
        ...
        <div class="container">
          <div class="row">
            <div class="text text-center mx-auto">
              <h3>Resistência, nossos produtos são confeccionados com materiais de alta qualidade
                 e pensados especialmente para atender os perfis mais exigentes.</h3>
            </div>
          </div>
        </div>
    </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <?php
           ...
           $get_products = "select * from products where id_categoria = 4";
    ...
    <footer class="footer bg-dark">
      <div class="container">
       <div class="row">
          <h6 class=" mx-auto mt-2 text-light">Desenvolvido Por: <a href="https://www.linkedin.com/in/wayster-de-mello-b32278105/" class="text-light">Wayster D' Mello</a></h6>
       </div>
      </div>
    </footer>
