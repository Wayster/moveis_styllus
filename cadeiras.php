...
<!--</script>-->
    ...
    <link rel="stylesheet" href="css/EstiloCadeiras1.css">
  ...
  <div class="inicio">
      <div class="overlay">
          <h1 class="text text-center" alt="styllus moveis, stylus moveis, moveis, cadeiras">Cadeiras <br> com um Visual Extremamente Leve</h1>
          <p class=" text-center">Um design simples com estilo geométrico distinto</p>
      </div>
  </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
           ...
           $get_products = "select * from products where id_categoria = 1";
